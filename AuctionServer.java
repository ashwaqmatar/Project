...
public class AuctionServer {
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/MapData", request -> {
        ...
        server.createContext("/file", request -> {
        	...
        	Path path = Paths.get("HTMLFiles",fileName);
        	String output = null;
        ...
        System.out.println(MethodHandles.lookup().lookupClass().getSimpleName()+" is up. "+
        		"Try http://127.0.0.1:"+port+"/MapData?aaa,123 or http://127.0.0.1:"+port+"/file/ClientConverter.html");
        server.start();
    }
}
